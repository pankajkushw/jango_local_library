# Generated by Django 4.2.11 on 2025-06-08 05:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book gener. (e.g. Science Fiction, French poetry etc.', max_length=200, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
